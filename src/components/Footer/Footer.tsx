    ...
    return <Styled.Content>
        ...
        <Styled.CompanySocial>
            <Styled.CompanyContact>
                <WhatsAppIcon style={{ color: 'white' }} /> <Styled.SocialOption>+57 321 444 33 22</Styled.SocialOption>
            </Styled.CompanyContact>
            <Styled.CompanyContact>
                <EmailIcon style={{ color: 'white' }} /> <Styled.SocialOption>funbienestar@correo.com</Styled.SocialOption>
            </Styled.CompanyContact>
            <Styled.CompanyContact>
